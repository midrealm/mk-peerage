...
describe "Get /chambers/admin/add_new_candidate" do
  it "shows form for new user if admin user" do
    laurel = create(:user, role: :admin)
    sign_in(laurel)
    get "/chambers/admin/add_new_candidate"
  ...
  it "rasies AccessDenied Error if user is not an admin" do
    ...
    sign_in(laurel)
    expect{get "/chambers/admin/add_new_candidate"}.to raise_error(CanCan::AccessDenied)
  end
end
