...
describe "post /chambers/pelican/admin/poll" do
  before(:each) do
  ...
  it "creates new poll" do
    ...
    post '/chambers/pelican/admin/poll', params: @params
  ...
  it 'rejects garbage string' do
    expect(Poll.count).to eq(0)
    post '/chambers/pelican/admin/poll', params: { :poll => {start_date: 'aw;eofiajw', end_date: 'awfe;oiawj'} }
    expect(Poll.count).to eq(0)
  end 
end
