...
describe "Get /chambers/pelican/admin/pelicans/:id/edit" do
  context "for logged in pelican admin" do
    ...
    it "shows edit page for pelican" do
      ...
      get "/chambers/pelican/admin/pelicans/#{new_pelican.peers.first.id}/edit"
    ...
    it "raises Access Denied when editing non-pelican user" do
      laurel = create(:user)
      expect{get "/chambers/pelican/admin/pelicans/#{laurel.peers.first.id}/edit"}.to raise_error("Access Denied")

    end
  end
  it "redirects if not logged in" do
    pelican = create(:pelican, sca_name: 'Dingus McDOOOGLE')
    get "/chambers/pelican/admin/pelicans/#{pelican.peers.first.id}/edit"
