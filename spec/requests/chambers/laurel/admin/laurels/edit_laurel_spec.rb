...
describe "Get /chambers/laurel/admin/laurels/:id/edit" do
  context "for logged in pelican admin" do
    ...
    it "shows edit page for laurel" do
      ...
      get "/chambers/laurel/admin/laurels/#{new_laurel.peers.first.id}/edit"
    ...
    it "raises Access Denied when editing non-laurel user" do
      ...
      expect{get "/chambers/laurel/admin/laurels/#{pelican.peers.first.id}/edit"}.to raise_error("Access Denied")

    end
  end
  it "redirects if not logged in" do
    laurel = create(:user, sca_name: 'Dingus McDOOOGLE')
    get "/chambers/laurel/admin/laurels/#{laurel.peers.first.id}/edit"
